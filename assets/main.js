"use strict";
const sourceInput = document.querySelector('#source-tags');
const outputInput = document.querySelector('#formatted-tags');
...
async function copyFormattedTags() {
